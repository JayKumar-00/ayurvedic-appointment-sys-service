...
export class PatientRegisterController {
  ...
  createMedicineDispensing(@Body() createDto: CreatePatientRegisterDto) {
    return this.patientRegisterService.createPatientRegister(createDto);
  }
  ...
  @ApiInternalServerErrorResponse({ type: ApiErrorResponseDto })
  findAllAppointments() {
    return this.patientRegisterService.findAllPatientRegister();
  }
  ...
  findOne(@Param('id') id: string) {
    return this.patientRegisterService.findOnePatientRegister(id);
  }
  ...
  updateStatus(
    ...
    return this.patientRegisterService.changePatientRegisterStatus(id, isActive);
  }
  ...
  update(
    ...
    return this.patientRegisterService.updatePatientRegister(id, updateDto);
  }
  ...
  deleteAppointments(@Param('id') id: string) {
    return this.patientRegisterService.removePatientRegister(id);
  }
}
